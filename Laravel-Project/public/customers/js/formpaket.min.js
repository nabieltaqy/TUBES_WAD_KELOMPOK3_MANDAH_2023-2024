function Survey(survey) {
    ...
    function updateProgressbar() {
        ...
        if (index <= 3) {
            ...
            // Hapus langkah-langkah 4 dan 5 dari progress bar
            progressbar.setAttribute("aria-valuenow", 3);
            progressbar.setAttribute("aria-valuetext", "Question 3 of 3");
            progressbarStep[3].classList.add("active");
        }
    }
    ...
    function displayNextPanel() {
        ...
        if (+currentPanel.dataset.index === 3) {
            // Tambahkan kondisi untuk menyembunyikan tombol "Next" pada langkah-langkah 4 dan 5
    ...
    function displayPrevPanel() {
        ...
        if (+currentPanel.dataset.index < 3) {
            // Tambahkan kondisi untuk menyembunyikan tombol "Submit" pada langkah-langkah 4 dan 5
